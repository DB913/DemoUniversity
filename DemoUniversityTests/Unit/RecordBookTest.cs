...
public class RecordBookTest
{
    ...
    public void CreateRecordBookWithTwoOffsetTest()
    {
     ...
     [Fact]
    public void UpdateRecordBookTest()
    {
        var grade = 3;
        var faker = new Faker("ru");
        ...
        //student
        var studentUpdateId = Guid.NewGuid();
        ...
        var addressStudentUpdate = faker.Address.FullAddress();
        const string phoneStudentUpdate = "+37377954321";
        const int ageStudentUpdate = 25;
        const string specialityUpdate = "software";
        const int courseUpdate = 4;

        var studentUpdate = new Student(studentUpdateId,
            lastNameStudentUpdate,
            firstNameStudentUpdate,
            middleNameStudentUpdate,
            addressStudentUpdate,
            phoneStudentUpdate,
            ageStudentUpdate,
            specialityUpdate,
            courseUpdate);
        
        recordBook.UpdateRecordBook(studentUpdate, offsets);
    }
}